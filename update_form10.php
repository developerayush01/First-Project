...
if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET['edit'])) {
    ...
    $sql = "SELECT * FROM class_10 WHERE Roll_no = ?";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update'])) {
    ...
    $sql = "UPDATE class_10 SET Name=?, Address=?, Father_name=?, Contact_no=?, Total_fees=?, Cleared_Fees=? WHERE Roll_no=?";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssssddi", $name, $address, $father_name, $contact_no, $total_fees, $cleared_fees, $roll_no);
