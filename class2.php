...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['delete'])) {
    if (isset($_POST['roll_no'])) {
        ...
        $stmt = $conn->prepare("DELETE FROM class_2 WHERE Roll_no = ?");
        ...
        if ($stmt->execute() === TRUE) {
            ...
            $conn->query("UPDATE class_2 SET Roll_no = @count:= @count + 1");
            $conn->query("ALTER TABLE class_2 AUTO_INCREMENT = 1");
...
<body>
    <div class="navbar">
        ...
        <a href="add_student2.php">Add New Student</a>
    ...
    <div class="container">
        ...
        <div class="table-container">
            <table border="1">
                ...
                $sql = "SELECT Name, Roll_no, Address, Father_name, Contact_no, Total_fees, Cleared_Fees, (Total_fees - Cleared_Fees) AS Remaining_Fees FROM class_2";
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>
                                <form method='GET' action='update_form2.php' style='display:inline;'>
